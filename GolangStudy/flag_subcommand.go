...
/*
[fabrice@FabT480 studyGo] ./flag_subcommand 
expected 'foo' or 'bar' subcommands

[fabrice@FabT480 studyGo] ./flag_subcommand foo
subcommand 'foo'
  enable: false
  name: 
  tail: []

[fabrice@FabT480 studyGo] ./flag_subcommand foo -name=toto
subcommand 'foo'
  enable: false
  name: toto
  tail: []

[fabrice@FabT480 studyGo] ./flag_subcommand bar -name=toto
flag provided but not defined: -name
Usage of bar:
  -level int
    	level

[fabrice@FabT480 studyGo] ./flag_subcommand bar -level=12
subcommand 'bar'
  level: 12
  tail: []
*/
